...
with open('C:\\Users\Bob\Documents\Repos\QEPM\SSIS Packages\Stock Price Import\EODDataETL\config\config.yaml') as settings:
    cfg = yaml.load(settings)

local_root_directory = 'C:/InterfaceAndExtractFiles/MassStreet/'
exchange_directories = ['NASDAQ/','AMEX/','NYSE/','INDEX/']
...
def main():
    for ed in exchange_directories:
