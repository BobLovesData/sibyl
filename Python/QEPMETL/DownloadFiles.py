...
quarterly_real_gdp = quandl.get("FRED/GDPC1", authtoken="JGJJ9w_o6LJmuKT5SwgM")
...
annual_real_gdp = quandl.get("FRED/GDPCA", authtoken="JGJJ9w_o6LJmuKT5SwgM")
